...
const ScreenshotItem: React.FC<ScreenshotItemProps> = ({
  ...
  return (
    <>
      <div
        className={`border border-border relative ${isLoading ? "" : "group"}`}
      >
        ...
        {!isLoading && (
          <button
            ...
            className="absolute top-2 left-2 p-1 rounded-full bg-foreground/50 text-background opacity-0 group-hover:opacity-100 transition-opacity duration-300"
